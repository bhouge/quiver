 ...
 * Set the buffer, base frequency, and ADSR envelope
...
function MIDIInstrument(buffer, baseFreq, attack, decay, sustainLevel, release, completionCallback) {
	//alert(this);
	this.buffer = buffer;
	...
	//maybe this is not important...you're not going to get stuck MIDI notes, as you're specifying duration at note start
	//it would only be the case when you stupidly ask for a really long note, in which case, just refresh the page, no? 
	this.stop = function() {
		if (this.isPlaying) {
